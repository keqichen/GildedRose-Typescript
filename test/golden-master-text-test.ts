...
const item3 = new Item("Aged Brie3", 0, 1)
const item4 = new Item("Aged Brie", 7, 23)
const item5 = new Item("Aged Brie", 4, 11)
const item6 = new Item("Aged Brie", 11, 46)
const item7 = new Item("Aged Brie", 6, 23)
const item8 = new Item("Aged Brie", 0, 0)
...
const s4 = new Item("Sulfuras, Hand of Ragnaros", 0, 23)
